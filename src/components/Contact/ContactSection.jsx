...
export const ContactSection = () => {
    return (
        <section className="bento-grid m-t-4" id="contact">
            {/* Header */}
            <div className="col-span-12 text-center" style={{ marginBottom: '2rem' }}>
                <h2 className="fs-h2-mobile" style={{ fontSize: '3rem', color: 'var(--bg-dark)' }}>Get in Touch</h2>
            ...
            {/* Contact Form */}
            <div className="glass-panel col-span-7 p-2 p-md-3">
                <h3 style={{ fontSize: '2rem', marginBottom: '2rem', color: 'var(--bg-dark)' }}>Send Message</h3>
                <form className="flex-column" style={{ gap: '1.5rem' }}>
                    <div className="grid-cols-1-md-2" style={{ gap: '1rem' }}>
                        <div className="flex-column" style={{ gap: '0.5rem' }}>
                            <label style={{ fontWeight: 600, color: '#444' }}>First Name</label>
                            <input style={{ padding: '1rem', borderRadius: '12px', border: '1px solid #ddd', background: 'rgba(255,255,255,0.8)', width: '100%' }} placeholder="John" />
                        </div>
                        <div className="flex-column" style={{ gap: '0.5rem' }}>
                            <label style={{ fontWeight: 600, color: '#444' }}>Last Name</label>
                            <input style={{ padding: '1rem', borderRadius: '12px', border: '1px solid #ddd', background: 'rgba(255,255,255,0.8)', width: '100%' }} placeholder="Doe" />
                        </div>
                    </div>

                    <div className="flex-column" style={{ gap: '0.5rem' }}>
                        <label style={{ fontWeight: 600, color: '#444' }}>Email</label>
                        <input style={{ padding: '1rem', borderRadius: '12px', border: '1px solid #ddd', background: 'rgba(255,255,255,0.8)', width: '100%' }} placeholder="john@example.com" />
                    </div>

                    <div className="flex-column" style={{ gap: '0.5rem' }}>
                        <label style={{ fontWeight: 600, color: '#444' }}>Message</label>
                        <textarea style={{ padding: '1rem', borderRadius: '12px', border: '1px solid #ddd', background: 'rgba(255,255,255,0.8)', minHeight: '150px', width: '100%' }} placeholder="How can we help?" />
                    </div>
